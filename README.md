...
This GitHub repository is public. It will only be used during the initial setup.

The useful repositories (-root, -info, -G12, etc.) are private. You can only access them once you have registered. You will see a 404 error until you are registered.
